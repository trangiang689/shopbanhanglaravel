            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="logo pull-left">
                        <a href="index.html"><img src="fontend/images/logo.png" alt=""/></a>
                    </div>
                ...
                <div class="col-sm-9">
                    ...
                    <div class="mainmenu pull-left">
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            <li><a href="{{\Illuminate\Support\Facades\URL::to('/trang-chu')}}" class="active">Home</a></li>
            ...
            <div class="col-sm-3">
                <div class="left-sidebar">
                    ...
                    <div class="shipping text-center"><!--shipping-->
                        <img src="fontend/images/shipping.jpg" alt=""/>
                    </div><!--/shipping-->
